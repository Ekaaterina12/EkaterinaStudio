        ...
        <article class="artForm02">          
            ...
            <h2>Contacta con nosotros</h2>
                <div>
                    ...
                    <img src="<?= asset('assets/img/icons/mail-solid.svg') ?>" alt="icono solid" title="icono solid">
                    ...
                    <ul>
                        ...
                        <a href="mailto:aranaz@webda.eus" target="_blank">
                            <img src="<?= asset('assets/img/icons/mail-solid.svg') ?>" alt="icono emial" title="icono emial">
